...
import type { StepDirection } from "../core/types";
import { AnimationPriority, STEP_PRIORITY } from "../core/types";
import {
...
describe("StepAnimations", () => {
  ...
  describe("createStepConfig", () => {
    ...
    it.each(directions)(
      "should create config for %s direction",
      (direction) => {
