...
export const ANIMATION_ID_REGISTRY: ReadonlyMap<string, SkeletalAnimation> =
  new Map([
    ...
    ["gam_circular_parry", STANCE_ANIMATIONS.get("gam_circular_parry") ?? GAM_FLOW_DEFENSE], // Use dedicated circular parry animation or fallback
    ...
    ["gan_immovable_stance", STANCE_ANIMATIONS.get("gan_immovable_stance") ?? GAN_IMMOVABLE_BLOCK], // Use dedicated immovable stance animation or fallback
