/**
 * Type definitions for the systems layer.
 *
 * Defines interfaces and data structures used across the combat,
 * animation, physics, and effect subsystems.
 *
 * @module systems/types
