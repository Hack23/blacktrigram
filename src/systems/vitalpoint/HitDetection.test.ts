...
import { VitalPointCategory, VitalPointEffectType, VitalPointSeverity } from "../../types/common";
...
describe("HitDetection", () => {
  ...
  describe("processVitalPointHit", () => {
    it("should detect hit within radius", () => {
      ...
      const result = hitDetection.processVitalPointHit(mockVitalPoint, hitPosition, 60);
    ...
    it("should miss when outside radius", () => {
      ...
      const result = hitDetection.processVitalPointHit(mockVitalPoint, missPosition, 60);
    ...
    it("should handle vital point at boundary of radius", () => {
      ...
      const result = hitDetection.processVitalPointHit(mockVitalPoint, boundaryPosition, 60);
    ...
    it("should handle vital point just outside radius", () => {
      ...
      const result = hitDetection.processVitalPointHit(mockVitalPoint, outsidePosition, 60);
    ...
    it("should use default radius if undefined", () => {
      ...
      const result = hitDetection.processVitalPointHit(noRadiusVP, hitPosition, 60);
    ...
    it("should use default required force if undefined", () => {
      ...
      const result = hitDetection.processVitalPointHit(noForceVP, hitPosition, 60);
    ...
    it("should use default base damage if undefined", () => {
      ...
      const result = hitDetection.processVitalPointHit(noDamageVP, hitPosition, 60);
    ...
    it("should floor damage to integer", () => {
      const hitPosition = { x: 100, y: 100 };
      const result = hitDetection.processVitalPointHit(mockVitalPoint, hitPosition, 45);
    ...
    it("should handle zero force", () => {
      const hitPosition = { x: 100, y: 100 };
      const result = hitDetection.processVitalPointHit(mockVitalPoint, hitPosition, 0);
    ...
    it("should handle negative coordinates", () => {
      ...
      const result = hitDetection.processVitalPointHit(negativeVP, hitPosition, 60);
    ...
    it("should correctly calculate diagonal distance", () => {
      ...
      const result = hitDetection.processVitalPointHit(mockVitalPoint, diagonalPosition, 60);
  ...
  describe("effect conversion", () => {
    it("should map UNCONSCIOUSNESS to stun effect", () => {
      ...
      const hitPosition = { x: 100, y: 100 };
      const result = hitDetection.processVitalPointHit(vpWithEffect, hitPosition, 60);
    ...
    it("should preserve stackable property", () => {
      ...
      const hitPosition = { x: 100, y: 100 };
      const result = hitDetection.processVitalPointHit(vpWithStackable, hitPosition, 60);
    ...
    it("should set endTime correctly based on duration", () => {
      ...
      const expectedEndTime = result.effects[0].startTime + result.effects[0].duration;
    ...
    it("should handle multiple effects", () => {
      ...
      const hitPosition = { x: 100, y: 100 };
      const result = hitDetection.processVitalPointHit(vpWithMultipleEffects, hitPosition, 60);
    ...
    it("should handle empty effects array", () => {
      ...
      const result = hitDetection.processVitalPointHit(vpNoEffects, hitPosition, 60);
  ...
  describe("edge cases", () => {
    it("should handle exact position match", () => {
      ...
      const result = hitDetection.processVitalPointHit(mockVitalPoint, exactPosition, 60);
    ...
    it("should handle very large coordinates", () => {
      ...
      const result = hitDetection.processVitalPointHit(largeVP, hitPosition, 60);
    ...
    it("should handle very small radius", () => {
      ...
      const result = hitDetection.processVitalPointHit(smallRadiusVP, hitPosition, 60);
    ...
    it("should handle very large radius", () => {
      ...
      const result = hitDetection.processVitalPointHit(largeRadiusVP, farPosition, 60);
