...
import type { VirtualDPadProps } from "./VirtualDPad";
...
describe("VirtualDPad", () => {
  let onMoveMock: Mock<
    (direction: Direction | null, eventType: DPadEventType) => void
  >;
  let vibrateSpy: Mock<(pattern: number | number[]) => boolean>;
